...
app.get('/logout', function (req, res) {
   ...
   res.send('<html><body style="background-image: url(/ui/logout.jpg);background-size:cover;background-attachment: fixed;">Logged out!<br/><br/><a href="/">Back to home</a></body></html>');
});
