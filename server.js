...
function createTemplate (data) {
    ...
    <html>
      ...
      <body>
          <div class="container">
              <div>
                  <a href="/"><img src=/ui/home.gif/></a><br><br><br>
              </div>
              <hr/>
              <h3>
...
app.get('/references', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui', 'references.html'));
});
...
app.get('/logout', function (req, res) {
   ...
   res.send('<html><head><titile>LOGOUT</title><link rel="shortcut icon" href="/ui/ap.png"></head><body style="background-image: url(/ui/logout.jpg);background-size:cover;background-attachment: fixed;"><br><br><br><br><br><center><h1>Successfully logged out!<br/><br><br><img src="/ui/thanks.gif">Thanks for visiting<br/><a href="/"><img src=/ui/home.gif/></a></center></body></html>');
});
...
app.get('/ui/blue.gif', function (req, res) {
...
app.get('/ui/prbg.jpg', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui','prbg.jpg'));
});
...
app.get('/ui/pic07.jpg', function (req, res) {
  res.sendFile(path.join(__dirname, 'ui','pic07.jpg'));
});
