...
app.get('/logout', function (req, res) {
   ...
   res.send('<html><body style="background-image: url(/ui/logout.jpg);background-size:cover;background-attachment: fixed;"><centr>Logged out!<br/><img src="thanks.gif">Thanks for visiting<br/><a href="/">Back to home</a></center></body></html>');
});
